...
curDir = os.getcwd()
print(os.path.join(curDir, "CaseStudy\\mainScripts"))
sys.path.insert(
    0,
    os.path.join(curDir, "CaseStudy\\mainScripts"),
)
...
LinearStatic(
    analysis=analysis, analysis_cases=analysis_cases, solver_settings=settings
).solve()
